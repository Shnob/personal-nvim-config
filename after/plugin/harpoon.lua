...
vim.keymap.set("n", "<leader>1", function() ui.nav_file(5) end)
vim.keymap.set("n", "<leader>2", function() ui.nav_file(6) end)
vim.keymap.set("n", "<leader>3", function() ui.nav_file(7) end)
vim.keymap.set("n", "<leader>4", function() ui.nav_file(8) end)
