return
{
    ...
    keys = {
        ...
        { '<leader>frr', "<cmd>Telescope lsp_references<cr>",      { desc = "Tele: Lsp references" } },
        { '<leader>frd', "<cmd>Telescope lsp_definitions<cr>",     { desc = "Tele: Lsp definitions" } },
        { '<leader>fri', "<cmd>Telescope lsp_implementations<cr>", { desc = "Tele: Lsp implementations" } },
